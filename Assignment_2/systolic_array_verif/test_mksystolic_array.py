...
async def test_systolic_array(dut):
    ...
    await give_inputB1(dut,0)
    await give_inputB1(dut,4)
    await give_inputB1(dut,-1)
    await give_inputB1(dut,7)
    
    await give_inputB2(dut,0)
    await give_inputB2(dut,-11)
    await give_inputB2(dut,0)
    await give_inputB2(dut,13)
    
    await give_inputB3(dut,0)
    await give_inputB3(dut,7)
    await give_inputB3(dut,6)
    await give_inputB3(dut,1)
    
    await give_inputB4(dut,0)
    await give_inputB4(dut,0)
    await give_inputB4(dut,0)
    await give_inputB4(dut,0)
