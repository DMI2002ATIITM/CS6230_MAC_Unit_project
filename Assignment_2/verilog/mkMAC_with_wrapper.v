...
//
// On Thu Nov 21 17:09:08 IST 2024
//
//
// Ports:
// Name                         I/O  size props
...
module mkMAC_with_wrapper(CLK,
  ...
  // value method relay_A
  output [15 : 0] relay_A;
  output RDY_relay_A;

  // value method relay_B
  output [15 : 0] relay_B;
  output RDY_relay_B;

  // value method relay_S
  output relay_S;
  output RDY_relay_S;

  // signals for module outputs
  wire [31 : 0] output_MAC;
  wire [15 : 0] relay_A, relay_B;
  wire RDY_get_A,
       RDY_get_B,
       RDY_get_C,
       RDY_get_S1_or_S2,
  ...
  // inlined wires
  wire [32 : 0] inpC_fifo_rv_port1__read,
		inpC_fifo_rv_port1__write_1,
		inpC_fifo_rv_port2__read,
		out_fifo_rv_port0__write_1,
  ...
  // register first_data
  reg first_data;
  wire first_data_D_IN, first_data_EN;
  ...
  // register send_B
  reg [15 : 0] send_B;
  wire [15 : 0] send_B_D_IN;
  wire send_B_EN;

  // register send_nxt
  reg send_nxt;
  wire send_nxt_D_IN, send_nxt_EN;
  ...
  wire CAN_FIRE_RL_call_MAC,
       ...
       WILL_FIRE_RL_deassert_send_nxt,
  ...
  wire MUX_send_nxt_write_1__SEL_1;

  // remaining internal signals
  wire float_MAC_RDY_get_A_AND_float_MAC_RDY_get_B_AN_ETC___d17;
  ...
  // value method relay_A
  assign relay_A = inpA_fifo_rv[15:0] ;
  assign RDY_relay_A = RDY_relay_S ;

  // value method relay_B
  assign relay_B = send_B ;
  assign RDY_relay_B = send_nxt ;

  // value method relay_S
  assign relay_S = inpS_fifo_rv[0] ;
  assign RDY_relay_S =
	     inpA_fifo_rv[16] && inpS_fifo_rv[1] && inpC_fifo_rv[32] &&
	     float_MAC_RDY_get_A_AND_float_MAC_RDY_get_B_AN_ETC___d17 ;
  ...
  // rule RL_call_MAC
  assign CAN_FIRE_RL_call_MAC = RDY_relay_S ;
  assign WILL_FIRE_RL_call_MAC = RDY_relay_S ;

  // rule RL_deassert_send_nxt
  assign CAN_FIRE_RL_deassert_send_nxt = send_nxt ;
  assign WILL_FIRE_RL_deassert_send_nxt = send_nxt ;

  // inputs to muxes for submodule ports
  assign MUX_send_nxt_write_1__SEL_1 = EN_get_B && !first_data ;
  ...
  assign inpA_fifo_rv_port1__read =
	     RDY_relay_S ? inpA_fifo_rv_port0__write_1 : inpA_fifo_rv ;
  ...
  assign inpC_fifo_rv_port1__read =
	     RDY_relay_S ? out_fifo_rv_port0__write_1 : inpC_fifo_rv ;
  ...
  assign inpS_fifo_rv_port1__read =
	     RDY_relay_S ? inpS_fifo_rv_port0__write_1 : inpS_fifo_rv ;
  assign inpS_fifo_rv_port1__write_1 = { 1'd1, get_S1_or_S2_s1_or_s2 } ;
  assign inpS_fifo_rv_port2__read =
	     EN_get_S1_or_S2 ?
	       inpS_fifo_rv_port1__write_1 :
	       inpS_fifo_rv_port1__read ;
  assign out_fifo_rv_port0__write_1 =
	     { 1'd0,
	       32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  } ;
  assign out_fifo_rv_port1__read =
	     EN_output_MAC ? out_fifo_rv_port0__write_1 : out_fifo_rv ;
  ...
  // register first_data
  assign first_data_D_IN = 1'd0 ;
  assign first_data_EN = EN_get_B && first_data ;
  ...
  assign rg_S1_or_S2_EN = RDY_relay_S ;

  // register send_B
  assign send_B_D_IN = rg_B ;
  assign send_B_EN = MUX_send_nxt_write_1__SEL_1 ;

  // register send_nxt
  assign send_nxt_D_IN = MUX_send_nxt_write_1__SEL_1 ;
  assign send_nxt_EN = EN_get_B && !first_data || send_nxt ;
  ...
  // remaining internal signals
  assign float_MAC_RDY_get_A_AND_float_MAC_RDY_get_B_AN_ETC___d17 =
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        first_data <= `BSV_ASSIGNMENT_DELAY 1'd1;
	...
	send_B <= `BSV_ASSIGNMENT_DELAY 16'd0;
	send_nxt <= `BSV_ASSIGNMENT_DELAY 1'd0;
      end
    else
      begin
        if (first_data_EN)
	  first_data <= `BSV_ASSIGNMENT_DELAY first_data_D_IN;
	if (float_output_EN)
	...
	if (send_B_EN) send_B <= `BSV_ASSIGNMENT_DELAY send_B_D_IN;
	if (send_nxt_EN) send_nxt <= `BSV_ASSIGNMENT_DELAY send_nxt_D_IN;
      end
  end
