...
module mksystolic_array(CLK,
  ...
  // inlined wires
  wire [32 : 0] inpC1_fifo_rv_port1__read,
  ...
  assign CAN_FIRE_RL_relay_as_3_4 =
	     mac_4_RDY_get_A && mac_3_RDY_relay_S && mac_3_RDY_relay_A &&
	     mac_4_RDY_get_S1_or_S2 ;
  ...
  assign CAN_FIRE_RL_relay_as_2_3 =
	     mac_3_RDY_get_A && mac_2_RDY_relay_S && mac_2_RDY_relay_A &&
	     mac_3_RDY_get_S1_or_S2 ;
  ...
  assign CAN_FIRE_RL_get_ext_inp =
	     inpA1_fifo_rv[16] && inpC1_fifo_rv[32] && inpS1_fifo_rv[1] &&
	     mac_1_RDY_get_A &&
	     mac_1_RDY_get_C &&
	     mac_1_RDY_get_S1_or_S2 ;
  ...
  assign mac_1_EN_get_A = CAN_FIRE_RL_get_ext_inp ;
  ...
  assign mac_2_EN_get_A = CAN_FIRE_RL_relay_as_1_2 ;
