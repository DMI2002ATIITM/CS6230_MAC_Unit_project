...
module mkMAC_fp32(CLK,
  ...
  // inlined wires
  wire [32 : 0] abc_fifo_rv_port0__write_1,
  ...
  wire [16 : 0] ab_fifo_rv_port0__write_1,
  ...
  assign inpA_fifo_rv_port1__read =
	     CAN_FIRE_RL_init ? ab_fifo_rv_port0__write_1 : inpA_fifo_rv ;
  ...
  assign inpB_fifo_rv_port1__read =
	     CAN_FIRE_RL_init ? ab_fifo_rv_port0__write_1 : inpB_fifo_rv ;
